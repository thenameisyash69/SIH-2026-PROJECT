"""Update stored NASA confidence values using raw sqlite3 with same-connection verify."""
...
# Use raw sqlite3 with same connection for update and verify
